...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderIcon = function () {
    ...
    return _react2['default'].createElement('span', {
      className: (0, _classnames2['default'])(prefixCls + '-iconEle', prefixCls + '-icon__' + (_this2.getNodeState() || 'docu'), loadStatus === LOAD_STATUS_LOADING && prefixCls + '-icon_loading')
    });
  };
  ...
  this.renderSelector = function () {
    ...
    if (showIcon) {
      ...
      $icon = currentIcon ? _react2['default'].createElement(
        ...
        typeof currentIcon === 'function' ? _react2['default'].createElement(currentIcon, _this2.props) : currentIcon
      ) : _this2.renderIcon();
