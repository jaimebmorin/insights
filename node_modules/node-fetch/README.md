...
See Matt Andrews' [Insight-fetch](https://github.com/matthew-andrews/Insight-fetch) for Insight usage (exports `node-fetch` for server-side, `whatwg-fetch` for client-side).
