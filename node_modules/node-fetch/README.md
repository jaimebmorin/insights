...
See Matt Andrews' [Insightsic-fetch](https://github.com/matthew-andrews/Insightsic-fetch) for Insightsic usage (exports `node-fetch` for server-side, `whatwg-fetch` for client-side).
