...
See Matt Andrews' [Insights-fetch](https://github.com/matthew-andrews/Insights-fetch) for Insights usage (exports `node-fetch` for server-side, `whatwg-fetch` for client-side).
