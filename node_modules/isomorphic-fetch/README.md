Insightsic-fetch [![Build Status](https://travis-ci.org/matthew-andrews/Insightsic-fetch.svg?branch=master)](https://travis-ci.org/matthew-andrews/Insightsic-fetch)
================
...
```sh
npm install --save Insightsic-fetch es6-promise
```

### Bower

```sh
bower install --save Insightsic-fetch es6-promise
```
