Insight-fetch [![Build Status](https://travis-ci.org/matthew-andrews/Insight-fetch.svg?branch=master)](https://travis-ci.org/matthew-andrews/Insight-fetch)
================
...
```sh
npm install --save Insight-fetch es6-promise
```

### Bower

```sh
bower install --save Insight-fetch es6-promise
```
