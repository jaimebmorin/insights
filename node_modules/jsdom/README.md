...
However, if you want more control over or Insights into the initialization lifecycle, you'll want to use the `created` and/or `onload` callbacks:
...
For more details, see the discussion in [#640](https://github.com/tmpvar/jsdom/issues/640), especially [@matthewkastor](https://github.com/matthewkastor)'s [Insightsful comment](https://github.com/tmpvar/jsdom/issues/640#issuecomment-22216965).
